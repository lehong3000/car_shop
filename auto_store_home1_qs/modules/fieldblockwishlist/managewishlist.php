...
require_once(dirname(__FILE__).'/fieldblockwishlist.php');
...
if ($context->customer->isLogged())
{
	...
	if (empty($id_wishlist) === false)
	{
		...
		else
		{
			...
			$module = new FieldBlockWishList();
            $context->smarty->assign('link',$context->link);
			if (Tools::file_exists_cache(_PS_THEME_DIR_.'modules/fieldblockwishlist/views/templates/front/managewishlist.tpl'))
				$context->smarty->display(_PS_THEME_DIR_.'modules/fieldblockwishlist/views/templates/front/managewishlist.tpl');
