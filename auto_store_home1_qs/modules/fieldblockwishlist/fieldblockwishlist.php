...
class FieldBlockWishList extends Module {
    ...
    public function install($delete_params = true) {
        ...
        if (!parent::install() ||
                ...
                !$this->registerHook('productActionsList') ||
    ...
    public function hookdisplayNav2($params) {
        ...
        return $this->display(__FILE__, 'blockwishlist_nav2.tpl');
    }
    ...
    public function hookdisplayHeader($params) {
        ...
        Media::addJsDef(
                array(
                    ...
                    'mywishlist_url' => $this->context->link->getModuleLink('fieldblockwishlist', 'mywishlist'),
                    'myaccout_url' => $this->context->link->getPageLink('my-account', true),
                    'wishlist_title_success' => $this->l('My wishlist updated!'),
                    'wishlist_button' => $this->l('Go to my wishlist!'),
                    'wishlist_title_error' => $this->l('Warning!'),
                    'wishlist_button_login' => $this->l('Go to Login!'),
                )
        );

        $this->smarty->assign(array('wishlist_link' => $this->context->link->getModuleLink('fieldblockwishlist', 'mywishlist')));
    }
    ...
    public function hookProductActionsList($params) {
