...
include(dirname(__FILE__).'/../classes/fieldvmegamenu.class.php');
if (Tools::encrypt('fieldvmegamenu/index')!= Tools::getValue('pw')) {
    die("Access denied!");
}

$flexClass = new VMegaMenuItem();
...
if (Tools::getValue('updatecarousel') == 1) {	
	$res = $flexClass->updateSectionState(Tools::getValue('field'), Tools::getValue('data'), Tools::getValue('menuID'));
	echo $res;
}
?>