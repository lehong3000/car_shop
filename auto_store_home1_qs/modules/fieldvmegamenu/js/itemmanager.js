...
//    $(".bottom_carousel").change(function(){
//        var th = $(this);
//        var state = th.val();        
//        var field = th.data("dbname");
//        var menuID = $("#id_menu").val();  
//        $.ajax({                
//            data: 'updatecarousel=1&field='+field+'&data='+state+'&menuID='+menuID,
...
//    });
	...
	$(".removeThis").live("click", function() {	
		...
		$.ajax({   
			url: "../modules/fieldvmegamenu/ajax/queries.php",			
            data: 'menuID='+menuID+'&removeItem=1&field='+field+'&item='+item+'&pw='+pw,
            success: function(result){
    ...
    function getProducts(pID) {
		...
		$.ajax({
		    async:false,
		    url: '../modules/fieldvmegamenu/ajax/getimages.php',
		    data: 'pID='+pID+'&pw='+pw,
		    success: function(result){
				tmp = result;
		    }		    
...
//    }  
    ...
    function sectionState(name, state) {
        var menuID = $("#id_menu").val();
        $.ajax({                
            data: 'menuID='+menuID+'&changeState=1&name='+name+'&state='+state+'&pw='+pw,
            success: function(result){
                console.log(result);
            }
        });
    ...
    function sectionType(name, type) {
        ...
        $.ajax({    
			url: "../modules/fieldvmegamenu/ajax/queries.php",			
            data: 'menuID='+menuID+'&changeType=1&name='+name+'&type='+type+'&pw='+pw,
            success: function(result){
               //console.log(result);
            }
        });
    ...
    function sectionData(name, data) {
        ...
        var menuID = $("#id_menu").val();
        $.ajax({                
            data: 'menuID='+menuID+'&changeData=1&name='+name+'&data='+data+'&pw='+pw,
            success: function(result){
              console.log(result);
            }
        });
    ...
    function removeData(field) {
        ...
        $.ajax({   
			url: "../modules/fieldvmegamenu/ajax/queries.php",			
            data: 'menuID='+menuID+'&removeData=1&field='+field+'&pw='+pw,
            success: function(result){
              // console.log(result);
            }
        });
    ...
    function removeImage(type) {        
        var menuID = $("#id_menu").val();
        $.ajax({                
            data: 'menuID='+menuID+'&removeImage=1&type='+type+'&pw='+pw,
            success: function(result){
//               console.log(result);
    ...
    function updateMenuItem(val, link, langid) {
        ...
        $.ajax({    
			url: "../modules/fieldvmegamenu/ajax/queries.php",			
            data: 'menuID='+menuID+'&updateMenuItem=1&val='+val+'&shopid='+shopID+'&langid='+langID+'&pw='+pw,
            success: function(result){
...
//              console.log(result);
    ...
    function updateMenuState(val) {
        ...
        $.ajax({     
			url: "../modules/fieldvmegamenu/ajax/queries.php",			
            data: 'menuID='+menuID+'&updateMenuState=1&val='+val+'&shopid='+shopID+'&pw='+pw,
            success: function(result){  
            }
        });
    }
    function updateMenuType(val) {
        ...
        $.ajax({      
			url: "../modules/fieldvmegamenu/ajax/queries.php",			
            data: 'menuID='+menuID+'&updateMenuType=1&val='+val+'&shopid='+shopID+'&pw='+pw,
            success: function(result){  
	...
	function getUrl(input, elID, field) {
        if (input.files && input.files[0]) {
            ...
            $.ajax({          
				url: "../modules/fieldvmegamenu/ajax/queries.php",			
	            data: 'menuID='+menuID+'&changeData=1&name='+field+'&data='+input.files[0]["name"]+'&pw='+pw,
	            success: function(result){
//	              console.log(result);
	            }
	        });
	...
	function uploader(thisa, resp) {
        ...
        if (formdata) {
            $.ajax({
                url: "../modules/fieldvmegamenu/ajax/upload.php?pw="+pw,
                type: "POST",
                data: formdata,
                processData: false,
                contentType: false,
