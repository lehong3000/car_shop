...
class FieldPopupNewsletter extends Module
{
	...
	{		
                ...
                foreach (Language::getLanguages() as $language){
                    $title[(int)$language['id_lang']] = '<h2>NEWSLETTER</h2>';
                    $content[(int)$language['id_lang']] = '<p>Subscribe to the Auto Store mailing list to receive updates on new</p><p>arrivals, special offers and other discount information.</p>';
                }
		...
		if (
			...
			|| Configuration::updateValue('FIELD_HEIGHT', 450) == false
