...
class FieldNewProductSlider extends Module
{
	...
	public function uninstall()
	{
        ...
        private function _createConfigs()
        {
            ...
            foreach ($languages as $language){
                $title[$language['id_lang']] = 'New Arrivals';
            }
            ...
            $response &= Configuration::updateValue('FIELD_NEWPSL_COLUMNITEM', 4);
	...
	private function getNewProducts()
	{
		...
		if (Configuration::get('PS_NB_DAYS_NEW_PRODUCT'))
			$newProducts = Product::getNewProducts((int) $this->context->language->id, 0, (int)Configuration::get('FIELD_NEWPSL_NBR'));
