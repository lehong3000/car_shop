...
if ($context->customer->isLogged()) {
    ...
    if (($add || $delete) && empty($id_product) === false) {
        if (!isset($context->cookie->id_wishlist) || $context->cookie->id_wishlist == '') {
            ...
            $mod_wishlist = new FieldBlockWishList();
    ...
    if (Tools::file_exists_cache(_PS_THEME_DIR_ . 'modules/fieldblockwishlist/blockwishlist-ajax.tpl'))
        $context->smarty->display(_PS_THEME_DIR_ . 'modules/fieldblockwishlist/blockwishlist-ajax.tpl');
