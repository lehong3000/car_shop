...
class smartblog extends Module {
    ...
    public function install(){
            Configuration::updateGlobalValue('smartpostperpage', '6');
    ...
    public function hookDisplayHeader($params) {
		...
		$this->smarty->assignGlobal('size_'.str_replace('-','_',$image_type['type_name']).'_'.$image_type['type'],$image_type);	
                }
    ...
    private function CreateSmartBlogTabs() {
                ...
                foreach($langs as $l){
                        $smarttab->name[$l['id_lang']] = $this->l('SmartBlog Configure');
                }
                $smarttab->save();
         ...
         $languages = Language::getLanguages(false);
                for ($i = 1; $i <= 8; $i++){
                     if($i==1):
                        ...
                        $slug='vulputate-cursus';
			$des='At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium. At Nulla id tincidunt ut sed semper vel Lorem condimentum ornare. Laoreet Vestibulum lacinia massa a commodo habitasse velit Vestibulum tincidunt In. Turpis at eleifend leo mi elit Aenean porta ac sed faucibus. Nunc urna Morbi fringilla vitae orci convallis condimentum auctor sit dui. Urna pretium elit mauris cursus Curabitur at elit Vestibulum.';
                    elseif($i==2):
                        $title='Accumsan Ipsum';
                       $slug='accumsan-ipsum';
			$des='At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium. At Nulla id tincidunt ut sed semper vel Lorem condimentum ornare. Laoreet Vestibulum lacinia massa a commodo habitasse velit Vestibulum tincidunt In. Turpis at eleifend leo mi elit Aenean porta ac sed faucibus. Nunc urna Morbi fringilla vitae orci convallis condimentum auctor sit dui. Urna pretium elit mauris cursus Curabitur at elit Vestibulum.';
                    elseif($i==3):
			...
			$des='At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium. At Nulla id tincidunt ut sed semper vel Lorem condimentum ornare. Laoreet Vestibulum lacinia massa a commodo habitasse velit Vestibulum tincidunt In. Turpis at eleifend leo mi elit Aenean porta ac sed faucibus. Nunc urna Morbi fringilla vitae orci convallis condimentum auctor sit dui. Urna pretium elit mauris cursus Curabitur at elit Vestibulum.';
                    elseif($i==4):
                        $title='Bibendum Auctor';
                        $slug='bibendum-auctor';
			$des='At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium. At Nulla id tincidunt ut sed semper vel Lorem condimentum ornare. Laoreet Vestibulum lacinia massa a commodo habitasse velit Vestibulum tincidunt In. Turpis at eleifend leo mi elit Aenean porta ac sed faucibus. Nunc urna Morbi fringilla vitae orci convallis condimentum auctor sit dui. Urna pretium elit mauris cursus Curabitur at elit Vestibulum.';
                    elseif($i==5):
                        $title='Bibendum Auctor';
                        $slug='bibendum-auctor';
                    ...
                    foreach ($languages as $language){
                       ...
                       INSERT INTO `'._DB_PREFIX_.'smart_blog_post_lang`(`id_smart_blog_post`,`id_lang`,`meta_title`,`meta_description`,`short_description`,`content`,`link_rewrite`)
                        VALUES('.$i.','.(int)$language['id_lang'].', 
							...
							"'.htmlspecialchars($des).'","<p>'.substr($des,0,200).'</p>","<p>'.htmlspecialchars($des).'</p>","'.$slug.'"
						)'))
						 return false;
                    }
                }
