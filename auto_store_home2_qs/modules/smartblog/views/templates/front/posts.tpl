...
<div id="content" class="block">
	...
	<div class="sdsblogArticle-inner" itemprop="articleBody">
        ...
        <span>
        	<i class="fa fa-comments"></i>{if $countcomment != ''}{$countcomment}{else}{l s='0' mod='smartblog'}{/if}{l s=' Comments' mod='smartblog'}
        </span>
...
<div class="smartblogcomments" id="respond">
	...
	<h4 class="comment-reply-title" id="reply-title">
	    {l s='Leave your reply'  mod='smartblog'} 
	...
	<div id="commentInput">
		...
		<form action="" method="post" id="commentform">
			...
			<label>{l s='Name:'  mod='smartblog'}</label><sup>*</sup>
			<input type="text" tabindex="1" class="inputName form-control grey" value="" name="name">
		    </div>
		    <div class="required form-group col-xs-12 col-sm-12 col-md-6">
			<label>{l s='E-mail:'  mod='smartblog'}</label><sup>*</sup><span class="note"><sup>*</sup>{l s='Not Published'  mod='smartblog'}</span>
			<input type="text" tabindex="2" class="inputMail form-control grey" value="" name="mail">
		    </div>
		    <div class="required form-group col-xs-12">
			<label>{l s='Website:'  mod='smartblog'}</label><span class="note"><sup>*</sup>{l s='Site url with'  mod='smartblog'}&nbsp;http://</span>
			<input type="text" tabindex="3" value="" name="website" class="form-control grey">
		    </div>																
		    <div class="required form-group col-xs-12">
			<label>{l s='Comment:'  mod='smartblog'}</label><sup>*</sup>
		    ...
		    {if Configuration::get('smartcaptchaoption') == '1'}
				...
				<label>{l s='Type Code' mod='smartblog'}</label>
			...
			<input type="submit" name="addComment" id="submitComment" class="bbutton btn btn-default button-medium" value="{l s='Submit comment' mod='smartblog'}">
		    </div>
		</form>
	    </div>
	</div>
