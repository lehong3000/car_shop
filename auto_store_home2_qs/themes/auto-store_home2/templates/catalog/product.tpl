...
<h2 style="display:none !important">.</h2>
    <div class="row">
      <div class="{if isset($FIELD_productVerticalThumb) && $FIELD_productVerticalThumb==1}col-md-7{else}col-md-6{/if}">
        ...
        <div class="{if isset($FIELD_productVerticalThumb) && $FIELD_productVerticalThumb==1}col-md-5{else}col-md-6{/if}">
          ...
          {/block}
            ...
            <div id="field_site_guichart">{$smarty.capture.siteguichart nofilter}</div>
            {/if}
        </div>
      </div>
    </div>
