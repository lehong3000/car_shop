	...
	public function uninstall()
	{
        ...
        private function _createConfigs()
        {
            ...
            foreach ($languages as $language){
                $title[$language['id_lang']] = 'viewed products';
            }
            $response = Configuration::updateValue('FIELD_SPECIALPLS_NBR', 9);
            ...
            $response &= Configuration::updateValue('FIELD_SPECIALPLS_COLUMNITEM',3);
            ...
            $response &= Configuration::updateValue('FIELD_SPECIALPLS_NAVIGATION', 1);
            return $response;
        }
