	...
	public function uninstall()
	{
        ...
        private function _createConfigs()
        {
            ...
            foreach ($languages as $language){
                $title[$language['id_lang']] = 'Hot deals';
            }
            $response = Configuration::updateValue('FIELD_FEATUREDPSL_NBR', 9);
            ...
            $response &= Configuration::updateValue('FIELD_FEATUREDPSL_VERTICAL', 1);
            $response &= Configuration::updateValue('FIELD_FEATUREDPSL_COLUMNITEM', 3);
            $response &= Configuration::updateValue('FIELD_FEATUREDPSL_MAXITEM', 1);
            $response &= Configuration::updateValue('FIELD_FEATUREDPSL_MEDIUMITEM', 1);
