...
class ProductComments extends Module {
    ...
    public function __construct() {
        ...
        $this->displayName = $this->l('Field Product Comments');
...
// Check for parent tab2
        ...
        $tab = new Tab();
        $tab->active = 1;
        $tab->class_name = ("AdminModules" . "&configure=productcomments");
        $tab->name = array();
        foreach (Language::getLanguages() as $lang) {
            $tab->name[$lang['id_lang']] = "Config ProductComments";
        }
...
// Get the number of tabs inside our parent tab
    ...
    public function hookdisplayHeader() {
        $this->context->controller->addCSS($this->_path . '/productcomments.css');
