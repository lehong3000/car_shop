	...
	public function uninstall()
	{
        ...
        private function _createConfigs()
        {
            ...
            foreach ($languages as $language){
                $title[$language['id_lang']] = 'Top rate';
            }
            ...
            $response &= Configuration::updateValue('FIELD_ONECATEPSL_VERTICAL', 1);
            $response &= Configuration::updateValue('FIELD_ONECATEPSL_COLUMNITEM', 3);
            ...
            $response &= Configuration::updateValue('FIELD_ONECATEPSL_NAVIGATION', 1);
