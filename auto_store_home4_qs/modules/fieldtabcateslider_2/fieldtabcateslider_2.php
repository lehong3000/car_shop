	...
	public function uninstall()
	{
        ...
        private function _createConfigs()
        {
            ...
            foreach ($languages as $language){
                $title[$language['id_lang']] = 'sale Products';
            ...
            $response = Configuration::updateGlobalValue('FIELD_TABCATEPSL_2_ICONS','');
	    ...
	    $response &= Configuration::updateValue('FIELD_TABCATEPSL_2_PR_AUTO', '');
            ...
            $response &= Configuration::updateValue('FIELD_TABCATEPSL_2_MAXITEM', 5);
...
// Check for parent tab2
	...
	public function getContent()
	{
		...
		if (Tools::isSubmit('submitFieldTabCateSlider_2'))
		{
                        ...
                        if (Tools::isSubmit('FIELD_TABCATEPSL_2_ICONS'))
                                Configuration::updateValue('FIELD_TABCATEPSL_2_ICONS', Tools::getValue('FIELD_TABCATEPSL_2_ICONS'));
	...
	public function renderForm()
	{
                                        ...
                                        array(
                                            ...
                                            'options' => array(
                                                ...
                                                'name' => 'name'
                                                  ...
                                                  array(
                                                'type' => 'text',
                                                'name' => 'FIELD_TABCATEPSL_2_ICONS',
                                                'label' => $this->l('Icons'),
                                                'desc' => $this->l('The icons of the columns'),
                                                'required' => false,
                                                'lang' => false,
                                            ),
                                        array(
		...
		$helper->module = $this;
                ...
                $helper->fields_value['FIELD_TABCATEPSL_2_ICONS'] = Configuration::get('FIELD_TABCATEPSL_2_ICONS');
	...
	{   
                ...
                $arrayCategory = array();
                $catIcons = Configuration::get('FIELD_TABCATEPSL_2_ICONS');
                $cateIcon = explode(',', $catIcons);
                
               // var_dump($cateIcon);
                $catSelected = Configuration::get('FIELD_TABCATEPSL_2_CAT');
                $cateArray = explode(',', $catSelected); 
               // echo count($cateArray);
                 //var_dump(count($catSelected));
//                $cateIcon = array(50);
//                 for ($i = 0; $i < 50; $i++){
//                  
//                        $cateIcon[$i]=null;
...
//                }
                ...
                for ($i = 0; $i < count($cateArray); $i++){
                    if(!isset($cateIcon[$i]) || ($cateIcon[$i]==null)){
                        $cateIcon[$i]="default";
                    }
                }
