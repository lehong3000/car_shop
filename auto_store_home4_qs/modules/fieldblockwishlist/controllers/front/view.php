...
class FieldBlockWishListViewModuleFrontController extends ModuleFrontController
{
	...
	public function __construct()
	{
		...
		include_once($this->module->getLocalPath().'fieldblockwishlist.php');
	}
	...
	public function initContent()
	{
		...
		$this->setTemplate('module:fieldblockwishlist/views/templates/front/view.tpl');
	}
}